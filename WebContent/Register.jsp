...
<form:form id="form" method="post" action="/Fleet/ConfirmBooking.do" commandName="myregister">
<table>
<tr>
<td>
First Name 
...
<td>
<form:input path="preferedCarType"/>
</td>
<td>
<form:errors path="preferedCarType" cssClass="error"/>
</td>
</tr>
